...
# revision_docs:5cc58168292cad8c2c804e39d521843bb8f467c0
# revision_generator:HEAD/2020-03-30T111403/soenke
require 'ostruct'
require 'net/https'
require 'uri'
require 'cgi'
...
module ResponseObjects
    ...
    class Space < ::OpenStruct
      #created_at, id, name, projects, projects_count, updated_at,
      def initialize(hash)
        super(hash)
        PhraseApp.handle_times(self)
      end
    ...
    class SummaryType < ::OpenStruct
      #locales_created, tags_created, translation_keys_created, translation_keys_ignored, translation_keys_unmentioned, translation_keys_updated, translations_created, translations_updated,
      def initialize(hash)
        super(hash)
        PhraseApp.handle_times(self)
      end
    ...
    class Translation < ::OpenStruct
      #content, created_at, excluded, id, key, locale, placeholders, plural_suffix, state, unverified, updated_at,
      def initialize(hash)
        super(hash)
        PhraseApp.handle_times(self)
      end
    ...
    class Upload < ::OpenStruct
      #created_at, filename, format, id, state, summary, tag, updated_at,
      def initialize(hash)
        super(hash)
        PhraseApp.handle_times(self)
      end
...
module RequestParams
  ...
  # == Parameters:
  # id::
  #   Project ID to add to the Space
  # name::
  #   Name of the project
  class SpaceParams < ::OpenStruct
    ...
    def validate
      ...
      if id == nil || id == ""
        raise PhraseApp::ParamsHelpers::ParamsValidationError.new("Required parameter \"id\" of \"SpaceParams\" not set")
      end
      if name == nil || name == ""
        raise PhraseApp::ParamsHelpers::ParamsValidationError.new("Required parameter \"name\" of \"SpaceParams\" not set")
      end
    end
...
module RequestParams
  ...
  # name::
  #   Name of the space
  class SpaceCreateParams < ::OpenStruct
    ...
    def validate
      ...
      if name == nil || name == ""
        raise PhraseApp::ParamsHelpers::ParamsValidationError.new("Required parameter \"name\" of \"space_createParams\" not set")
      end
    end
...
module RequestParams
  ...
  class SpaceUpdateParams < ::OpenStruct
...
module RequestParams
  # SpacesProjectsCreateParams
  # == Parameters:
  # id::
  #   Project ID to add or to the Space
  class SpacesProjectsCreateParams < ::OpenStruct
    ...
    def validate
      ...
      if id == nil || id == ""
        raise PhraseApp::ParamsHelpers::ParamsValidationError.new("Required parameter \"id\" of \"spaces_projects_createParams\" not set")
      end
    end
...
module RequestParams
  # TranslationExcludeParams
  # == Parameters:
  # branch::
  #   specify the branch to use
  class TranslationExcludeParams < ::OpenStruct
...
module RequestParams
  # TranslationIncludeParams
  # == Parameters:
  # branch::
  #   specify the branch to use
  class TranslationIncludeParams < ::OpenStruct
...
module RequestParams
  # TranslationReviewParams
  # == Parameters:
  # branch::
  #   specify the branch to use
  class TranslationReviewParams < ::OpenStruct
...
module RequestParams
  # TranslationUnverifyParams
  # == Parameters:
  # branch::
  #   specify the branch to use
  class TranslationUnverifyParams < ::OpenStruct
...
module RequestParams
  # TranslationVerifyParams
  # == Parameters:
  # branch::
  #   specify the branch to use
  class TranslationVerifyParams < ::OpenStruct
...
module RequestParams
  # TranslationsReviewParams
  # == Parameters:
  # branch::
  #   specify the branch to use
  # q::
  #   q_description_placeholder
  class TranslationsReviewParams < ::OpenStruct
...
module RequestParams
  ...
  class Client
    ...
    # API Path: /v2/bitbucket_syncs/:id/export
    # == Parameters:
    # id::
    #   id
    # params::
    ...
    # API Path: /v2/bitbucket_syncs/:id/import
    # == Parameters:
    # id::
    #   id
    # params::
    ...
    # API Path: /v2/projects/:project_id/branches/:name/compare
    # == Parameters:
    # project_id::
    #   project_id
    # name::
    ...
    # == Returns:
    #   err
    def branch_compare(project_id, name, params)
      path = sprintf("/api/v2/projects/%s/branches/%s/compare", project_id, name)
      data_hash = {}
      post_body = nil
    ...
    # Create a new branch.
    # API Path: /v2/projects/:project_id/branches
    # == Parameters:
    # project_id::
    #   project_id
    # params::
    ...
    # API Path: /v2/projects/:project_id/branches/:name
    # == Parameters:
    # project_id::
    #   project_id
    # name::
    ...
    # == Returns:
    #   err
    def branch_delete(project_id, name)
      path = sprintf("/api/v2/projects/%s/branches/%s", project_id, name)
      data_hash = {}
      post_body = nil
    ...
    # API Path: /v2/projects/:project_id/branches/:name/merge
    # == Parameters:
    # project_id::
    #   project_id
    # name::
    ...
    # == Returns:
    #   err
    def branch_merge(project_id, name, params)
      path = sprintf("/api/v2/projects/%s/branches/%s/merge", project_id, name)
      data_hash = {}
      post_body = nil
    ...
    #   PhraseApp::ResponseObjects::Branch
    #   err
    def branch_show(project_id, name)
      path = sprintf("/api/v2/projects/%s/branches/%s", project_id, name)
      data_hash = {}
      post_body = nil
    ...
    #   PhraseApp::ResponseObjects::Branch
    #   err
    def branch_update(project_id, name, params)
      path = sprintf("/api/v2/projects/%s/branches/%s", project_id, name)
      data_hash = {}
      post_body = nil
    ...
    # API Path: /v2/accounts/:account_id/distributions
    # == Parameters:
    # account_id::
    #   account_id
    # params::
    ...
    # API Path: /v2/accounts/:account_id/distributions/:id
    # == Parameters:
    # account_id::
    #   account_id
    # id::
    ...
    # API Path: /v2/projects/:project_id/jobs/:id/reopen
    # == Parameters:
    # project_id::
    #   project_id
    # id::
    ...
    # API Path: /v2/projects/:project_id/jobs/:job_id/locales/:id/complete
    # == Parameters:
    # project_id::
    #   project_id
    # job_id::
    ...
    # API Path: /v2/projects/:project_id/jobs/:job_id/locales/:id/reopen
    # == Parameters:
    # project_id::
    #   project_id
    # job_id::
    ...
    # API Path: /v2/accounts/:account_id/distributions/:distribution_id/releases
    # == Parameters:
    # account_id::
    #   account_id
    # distribution_id::
    ...
    # API Path: /v2/accounts/:account_id/distributions/:distribution_id/releases/:id
    # == Parameters:
    # account_id::
    #   account_id
    # distribution_id::
    ...
    # API Path: /v2/accounts/:account_id/distributions/:distribution_id/releases/:id/publish
    # == Parameters:
    # account_id::
    #   account_id
    # distribution_id::
    ...
    # API Path: /v2/projects/:project_id/screenshots
    # == Parameters:
    # project_id::
    #   project_id
    # params::
    ...
    # API Path: /v2/projects/:project_id/screenshots/:id
    # == Parameters:
    # project_id::
    #   project_id
    # id::
    ...
    # API Path: /v2/projects/:project_id/screenshots/:screenshot_id/markers
    # == Parameters:
    # project_id::
    #   project_id
    # screenshot_id::
    ...
    # API Path: /v2/projects/:project_id/screenshots/:screenshot_id/markers/:id
    # == Parameters:
    # project_id::
    #   project_id
    # screenshot_id::
    ...
    # API Path: /v2/projects/:project_id/screenshots/:id/markers
    # == Parameters:
    # project_id::
    #   project_id
    # id::
    ...
    # Create a new Space.
    # API Path: /v2/accounts/:account_id/spaces
    # == Parameters:
    # account_id::
    #   account_id
    # params::
    #   Parameters of type PhraseApp::RequestParams::SpaceCreateParams
    #
    # == Returns:
    #   PhraseApp::ResponseObjects::Space
    #   err
    def space_create(account_id, params)
      path = sprintf("/api/v2/accounts/%s/spaces", account_id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::SpaceCreateParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::SpaceCreateParams")
        end
      end
      ...
      return PhraseApp::ResponseObjects::Space.new(JSON.load(rc.body)), err
    end

    # Delete the specified Space.
    # API Path: /v2/accounts/:account_id/spaces/:id
    # == Parameters:
    # account_id::
    #   account_id
    # id::
    ...
    # == Returns:
    #   err
    def space_delete(account_id, id)
      path = sprintf("/api/v2/accounts/%s/spaces/%s", account_id, id)
      data_hash = {}
      post_body = nil
    ...
    #   id
    # params::
    #   Parameters of type PhraseApp::RequestParams::SpaceUpdateParams
    #
    # == Returns:
    #   PhraseApp::ResponseObjects::Space
    #   err
    def space_update(account_id, id, params)
      path = sprintf("/api/v2/accounts/%s/spaces/%s", account_id, id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::SpaceUpdateParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::SpaceUpdateParams")
        end
      end
    ...
    #   PhraseApp::ResponseObjects::Space
    #   err
    def spaces_list(account_id, page, per_page)
      path = sprintf("/api/v2/accounts/%s/spaces", account_id)
      data_hash = {}
      post_body = nil
      ...
      return JSON.load(rc.body).map { |item| PhraseApp::ResponseObjects::Space.new(item) }, err
    end

    # Adds an existing project to the space.
    # API Path: /v2/accounts/:account_id/spaces/:space_id/projects
    # == Parameters:
    # account_id::
    #   account_id
    # space_id::
    #   space_id
    # params::
    #   Parameters of type PhraseApp::RequestParams::SpacesProjectsCreateParams
    #
    # == Returns:
    #   err
    def spaces_projects_create(account_id, space_id, params)
      path = sprintf("/api/v2/accounts/%s/spaces/%s/projects", account_id, space_id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::SpacesProjectsCreateParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::SpacesProjectsCreateParams")
        end
      end
    ...
    # API Path: /v2/accounts/:account_id/spaces/:space_id/projects/:id
    # == Parameters:
    # account_id::
    #   account_id
    # space_id::
    ...
    # == Returns:
    #   err
    def spaces_projects_delete(account_id, space_id, id)
      path = sprintf("/api/v2/accounts/%s/spaces/%s/projects/%s", account_id, space_id, id)
      data_hash = {}
      post_body = nil
    ...
    #   PhraseApp::ResponseObjects::Project
    #   err
    def spaces_projects_list(account_id, space_id, page, per_page)
      path = sprintf("/api/v2/accounts/%s/spaces/%s/projects", account_id, space_id)
      data_hash = {}
      post_body = nil
    ...
    # API Path: /v2/projects/:project_id/translations/:id/exclude
    # == Parameters:
    # project_id::
    #   project_id
    # id::
    #   id
    # params::
    #   Parameters of type PhraseApp::RequestParams::TranslationExcludeParams
    #
    # == Returns:
    #   PhraseApp::ResponseObjects::TranslationDetails
    #   err
    def translation_exclude(project_id, id, params)
      path = sprintf("/api/v2/projects/%s/translations/%s/exclude", project_id, id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::TranslationExcludeParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::TranslationExcludeParams")
        end
      end
    ...
    # API Path: /v2/projects/:project_id/translations/:id/include
    # == Parameters:
    # project_id::
    #   project_id
    # id::
    #   id
    # params::
    #   Parameters of type PhraseApp::RequestParams::TranslationIncludeParams
    #
    # == Returns:
    #   PhraseApp::ResponseObjects::TranslationDetails
    #   err
    def translation_include(project_id, id, params)
      path = sprintf("/api/v2/projects/%s/translations/%s/include", project_id, id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::TranslationIncludeParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::TranslationIncludeParams")
        end
      end
    ...
    # API Path: /v2/projects/:project_id/translations/:id/review
    # == Parameters:
    # project_id::
    #   project_id
    # id::
    #   id
    # params::
    #   Parameters of type PhraseApp::RequestParams::TranslationReviewParams
    #
    # == Returns:
    #   PhraseApp::ResponseObjects::TranslationDetails
    #   err
    def translation_review(project_id, id, params)
      path = sprintf("/api/v2/projects/%s/translations/%s/review", project_id, id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::TranslationReviewParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::TranslationReviewParams")
        end
      end
    ...
    # API Path: /v2/projects/:project_id/translations/:id/unverify
    # == Parameters:
    # project_id::
    #   project_id
    # id::
    #   id
    # params::
    #   Parameters of type PhraseApp::RequestParams::TranslationUnverifyParams
    #
    # == Returns:
    #   PhraseApp::ResponseObjects::TranslationDetails
    #   err
    def translation_unverify(project_id, id, params)
      path = sprintf("/api/v2/projects/%s/translations/%s/unverify", project_id, id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::TranslationUnverifyParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::TranslationUnverifyParams")
        end
      end
    ...
    # API Path: /v2/projects/:project_id/translations/:id/verify
    # == Parameters:
    # project_id::
    #   project_id
    # id::
    #   id
    # params::
    #   Parameters of type PhraseApp::RequestParams::TranslationVerifyParams
    #
    # == Returns:
    #   PhraseApp::ResponseObjects::TranslationDetails
    #   err
    def translation_verify(project_id, id, params)
      path = sprintf("/api/v2/projects/%s/translations/%s/verify", project_id, id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::TranslationVerifyParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::TranslationVerifyParams")
        end
      end
    ...
    # API Path: /v2/projects/:project_id/translations/review
    # == Parameters:
    # project_id::
    #   project_id
    # params::
    #   Parameters of type PhraseApp::RequestParams::TranslationsReviewParams
    #
    # == Returns:
    #   PhraseApp::ResponseObjects::AffectedCount
    #   err
    def translations_review(project_id, params)
      path = sprintf("/api/v2/projects/%s/translations/review", project_id)
      data_hash = {}
      post_body = nil

      if params.present?
        unless params.kind_of?(PhraseApp::RequestParams::TranslationsReviewParams)
          raise PhraseApp::ParamsHelpers::ParamsError.new("Expects params to be kind_of PhraseApp::RequestParams::TranslationsReviewParams")
        end
      end
